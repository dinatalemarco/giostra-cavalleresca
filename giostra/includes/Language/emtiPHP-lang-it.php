...
class Language{
	...
	public static $success = "Operazione eseguita con successo";
	public static $error = "Si è verificato un errore, ti invitiamo a riprovare";
	public static $error403 = "403 Permesso Negato";
	public static $error404 = "404 Pagina Non Trovata";
	...
	public static $incorrectInput = "Input errato";
	//Fine
